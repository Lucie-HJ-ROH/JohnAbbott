...
mongoose.connect("mongodb+srv://mongouser:" + process.env.MONGODB_PWD +
    "@cluster0.b5oejtn.mongodb.net/myFirstDb?retryWrites=true&w=majority", { useNewUrlParser: true,
...
// const bcrypt = require("bcrypt"); //cross-orign resource sharing
// const app = express();
// const port = 3001; // Must be different than the port of the React app
// app.use(cors()); // https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS
//
// mongoose.connect("mongodb+srv://mongouser:" + process.env.MONGODB_PWD +
//     "@cluster0.b5oejtn.mongodb.net/myFirstDB?retryWrites=true&w=majority", {
